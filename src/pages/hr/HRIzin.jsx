  ...
  return (
    <div className="animate-fade-in space-y-4">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 md:p-6">
        <h2 className="text-lg md:text-xl font-bold text-text-primary mb-4">Daftar Izin & Cuti</h2>
        ...
        {leaves.length > 0 ? (
              ...
              <tbody>
                {leaves.map(leave => (
                  <tr key={leave.id} className="border-b border-gray-100 hover:bg-light-bg/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-text-primary hidden lg:table-cell">{leave.reason}</td>
                      ...
                      {leave.status === 'Pending' ? (
                        <div className="flex gap-2">
                          <button
                            ...
                            className="p-2 bg-status-success text-white rounded-lg hover:bg-emerald-700 transition-all focus:ring-2 focus:ring-green-300 focus:outline-none"
                            title="Setujui"
                          >
                            <CheckCircle size={18} />
                          </button>
                          <button
                            ...
                            className="p-2 bg-status-error text-white rounded-lg hover:bg-red-600 transition-all focus:ring-2 focus:ring-red-300 focus:outline-none"
                            title="Tolak"
                          >
                            <X size={18} />
                          </button>
          ...
          <div className="text-center py-8">
            <p className="text-text-secondary text-sm md:text-base">Tidak ada data izin/cuti</p>
          </div>
        )}
      </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <button
                ...
                className={`flex-1 text-white py-3 rounded-lg font-bold hover:opacity-90 transition-all text-sm md:text-base ${
                  confirmAction === 'approve' ? 'bg-green-500' : 'bg-red-500'
                }`}
              >
              ...
              <button
                ...
                className="flex-1 bg-gray-400 text-white py-3 rounded-lg font-bold hover:bg-gray-500 transition-all text-sm md:text-base"
              >
                Batal
              </button>
            </div>
